    ...
    <>
      <div className="terms">
        ...
        <p>
          ...
          use of Love: Infinity's Website, located at
          https://ssmdssmp.github.io/todolist_2/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Todolist if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing Todolist, you agreed to use
          cookies in agreement with the Love: Infinity's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Love: Infinity and/or its licensors own the
          intellectual property rights for all material on Todolist. All
          intellectual property rights are reserved. You may access this from
          Todolist for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Todolist</li>
          <li>Sell, rent or sub-license material from Todolist</li>
          <li>Reproduce, duplicate or copy material from Todolist</li>
          <li>Redistribute content from Todolist</li>
        </ul>
        ...
        <p>
          ...
          Love: Infinity does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Love: Infinity,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Love: Infinity
        ...
        <p>
          Love: Infinity reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Love: Infinity a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Love: Infinity; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Love: Infinity. Please include your name, your
        ...
        <p>
          No use of Love: Infinity's logo or other artwork will be allowed for
